            ...
            <div class="buttons flex-display align-self-center">
                ...
                if($table_name == "clients" && $action != "new"){
                    ...
                    if($row->blocked == 1){
                        ...
                        <button type="submit" class="block-client flex-display center align-center bold font-18">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                <g clip-path="url(#clip0_805_878)">
                                    <path d="M22 11C22 13.9174 20.8411 16.7153 18.7782 18.7782C16.7153 20.8411 13.9174 22 11 22C8.08262 22 5.28473 20.8411 3.22183 18.7782C1.15893 16.7153 0 13.9174 0 11C0 8.08262 1.15893 5.28473 3.22183 3.22183C5.28473 1.15893 8.08262 0 11 0C13.9174 0 16.7153 1.15893 18.7782 3.22183C20.8411 5.28473 22 8.08262 22 11ZM19.9375 11C19.9375 8.62963 18.9959 6.35634 17.3198 4.68023C15.6437 3.00413 13.3704 2.0625 11 2.0625C8.62963 2.0625 6.35634 3.00413 4.68023 4.68023C3.00413 6.35634 2.0625 8.62963 2.0625 11C2.0625 13.3704 3.00413 15.6437 4.68023 17.3198C6.35634 18.9959 8.62963 19.9375 11 19.9375C13.3704 19.9375 15.6437 18.9959 17.3198 17.3198C18.9959 15.6437 19.9375 13.3704 19.9375 11Z" fill="black"/>
                                    <g clip-path="url(#clip1_805_878)">
                                        <path d="M11.064 10.4883C11.8527 10.4883 12.6091 10.175 13.1668 9.61731C13.7245 9.0596 14.0378 8.3032 14.0378 7.51449C14.0378 6.72578 13.7245 5.96937 13.1668 5.41167C12.6091 4.85396 11.8527 4.54065 11.064 4.54065C10.2752 4.54065 9.51884 4.85396 8.96113 5.41167C8.40343 5.96937 8.09012 6.72578 8.09012 7.51449C8.09012 8.3032 8.40343 9.0596 8.96113 9.61731C9.51884 10.175 10.2752 10.4883 11.064 10.4883ZM13.0465 7.51449C13.0465 8.04029 12.8376 8.54456 12.4658 8.91637C12.094 9.28817 11.5898 9.49704 11.064 9.49704C10.5381 9.49704 10.0339 9.28817 9.66207 8.91637C9.29027 8.54456 9.0814 8.04029 9.0814 7.51449C9.0814 6.98868 9.29027 6.48441 9.66207 6.11261C10.0339 5.7408 10.5381 5.53193 11.064 5.53193C11.5898 5.53193 12.094 5.7408 12.4658 6.11261C12.8376 6.48441 13.0465 6.98868 13.0465 7.51449ZM17.0116 15.4447C17.0116 16.436 16.0203 16.436 16.0203 16.436H6.10756C6.10756 16.436 5.11628 16.436 5.11628 15.4447C5.11628 14.4534 6.10756 11.4796 11.064 11.4796C16.0203 11.4796 17.0116 14.4534 17.0116 15.4447ZM16.0203 15.4408C16.0194 15.1969 15.8677 14.4634 15.1956 13.7913C14.5493 13.145 13.333 12.4709 11.064 12.4709C8.79392 12.4709 7.57862 13.145 6.9323 13.7913C6.26022 14.4634 6.10954 15.1969 6.10756 15.4408H16.0203Z" fill="black"/>
                                    </g>
                                    <line x1="4.39273" y1="18.7183" x2="18.2067" y2="4.90439" stroke="black" stroke-width="2.04651"/>
                                </g>
                                <defs>
                                    <clipPath id="clip0_805_878">
                                        <rect width="22" height="22" fill="white"/>
                                    </clipPath>
                                    <clipPath id="clip1_805_878">
                                        <rect width="15.8605" height="15.8605" fill="white" transform="translate(5.11628 2.55811)"/>
                                    </clipPath>
                                </defs>
                            </svg>
                 ...
                 if($table_name == "orders" ){
                     ...
                     if(!isset($row->done) || !$row->done){?>
                            <button type="button" class="<?php echo is_manager() ? '':'hidden' ?> order-confirmation flex-display center align-center background-white dark-green bold font-18">
