...
-->        <?php if($field["widget"] ==  "file"){
        ...
        <input class="upload-<?php echo $field["widget"]?>" type="file" id="<?php echo $field["field_name"]?>" name="<?php echo 'file_'.$field["field_name"]?>" style="display: none;" required  accept="<?php echo $accept ?>"/>
