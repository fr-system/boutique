...
jQuery(document).ready(function($){
    ...
    jQuery(".page tr.product:not(.readonly) .order_price input:not([readonly])").change(function (e) {
        // var data={
        //     "action":"save_client_price",
        //     client_id:$("page")
        // }
        // call_ajax_function(data,"clientPrice")
        //שמירת מחיר מיוחד ללקח כשמשנים את המחיר בתוך ההזמנה
    })
